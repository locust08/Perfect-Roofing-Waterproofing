...
const roofingServices = [
  {
    ...
    image: "/images/roof-leak-repair-hero.png",
    imageSet: "/images/roof-leak-repair-hero.png 1448w",
    ...
    visualSigns: [
      { title: "Roof leak source inspection", text: "Check the affected area and trace the likely source of the leak.", image: "/images/roof-leak-repair-inspection.png" },
      { title: "Tile and flashing repair", text: "Repair damaged roof tiles and flashing around vulnerable joints.", image: "/images/roof-leak-repair-flashing.png" },
      { title: "Gutter and roof edge repair", text: "Check gutters and roof edges for drainage or fixing issues.", image: "/images/roof-leak-repair-gutter.png" },
      { title: "Ceiling water stain assessment", text: "Assess internal water stains to help identify the affected roof area.", image: "/images/roof-leak-repair-ceiling-stain.png" },
    ],
  },
  {
    title: "Roof Replacement & Re-roofing",
    slug: "roof-replacement-re-roofing",
    image: "/images/roof-replacement-hero.png",
    imageSet: "/images/roof-replacement-hero.png 1448w",
    ...
    visualSigns: [
      { title: "Existing roof condition assessment", text: "Assess the current roof condition before planning the replacement work.", image: "/images/roof-replacement-assessment.png" },
      { title: "Damaged roof removal", text: "Remove worn or damaged roof materials carefully before the new installation.", image: "/images/roof-replacement-removal.png" },
      { title: "Replacement material planning", text: "Review suitable replacement tiles and plan the roof layout.", image: "/images/roof-replacement-planning.png" },
      { title: "Re-roofing and final checks", text: "Install the replacement roof and complete final quality checks.", image: "/images/roof-replacement-final-checks.png" },
    ],
  },
  {
    title: "Roof Maintenance & Inspection",
    slug: "roof-maintenance-inspection",
    image: "/images/roof-maintenance-hero.png",
    imageSet: "/images/roof-maintenance-hero.png 1448w",
    ...
    visualSigns: [
      { title: "Roof condition inspection", text: "Inspect the roof condition and identify areas that need attention.", image: "/images/roof-maintenance-inspection.png" },
      { title: "Tile and flashing checks", text: "Check roof tiles and flashing for signs of damage or water entry.", image: "/images/roof-maintenance-flashing.png" },
      { title: "Gutter maintenance", text: "Clear gutters and check drainage paths to keep water flowing away from the roof.", image: "/images/roof-maintenance-gutter.png" },
      { title: "Preventive repair recommendations", text: "Review the findings and recommend repairs that help prevent future leaks.", image: "/images/roof-maintenance-recommendations.png" },
    ],
  },
  {
    title: "New Roof Installation",
    slug: "new-roof-installation",
    image: "/images/new-roof-installation-hero.png",
    imageSet: "/images/new-roof-installation-hero.png 1672w",
    ...
    visualSigns: [
      { title: "Site and roof layout assessment", text: "Assess the property and roof layout before planning the installation.", image: "/images/new-roof-installation-assessment.png" },
      { title: "Roof material selection", text: "Review suitable roofing materials and profiles with the property owner.", image: "/images/new-roof-installation-materials.png" },
      { title: "New roof installation", text: "Install the new roof system with the selected materials and proper fixing details.", image: "/images/new-roof-installation-work.png" },
      { title: "Completion inspection", text: "Inspect the completed roof and confirm the finished details.", image: "/images/new-roof-installation-completion.png" },
    ],
  },
  {
    title: "Roof Waterproofing",
    slug: "roof-waterproofing",
    image: "/images/roof-waterproofing-hero.png",
    imageSet: "/images/roof-waterproofing-hero.png 1448w",
    ...
    visualSigns: [
      { title: "Torch On membrane", text: "Apply torch-on membrane for robust waterproof protection on suitable flat roofs.", image: "/images/roof-waterproofing-torch-on-membrane.png" },
      { title: "Liquid membrane", text: "Apply liquid membrane to form a continuous waterproof layer across the roof surface.", image: "/images/roof-waterproofing-liquid-membrane.png" },
      { title: "Polyurethane or PU membrane", text: "Use a polyurethane membrane where a flexible, durable waterproof finish is suitable.", image: "/images/roof-waterproofing-pu-membrane.png" },
      { title: "Waterproofing coating", text: "Apply a waterproof coating evenly to protect exposed roof areas.", image: "/images/roof-waterproofing-coating.png" },
    ],
  },
  {
    title: "PU Injection & Water Leakage Repair",
    slug: "pu-injection-water-leakage-repair",
    image: "/images/pu-injection-hero.png",
    imageSet: "/images/pu-injection-hero.png 1672w",
    ...
    visualSigns: [
      { title: "Leak path inspection", text: "Inspect the affected area and trace the likely water entry path.", image: "/images/pu-injection-leak-inspection.png" },
      { title: "PU injection where suitable", text: "Inject PU material into suitable cracks and joints to stop water ingress.", image: "/images/pu-injection-repair.png" },
      { title: "Water seepage repair", text: "Treat active seepage at vulnerable joints and surface transitions.", image: "/images/pu-injection-seepage.png" },
      { title: "Post-repair checking", text: "Check the treated area after repair and confirm the waterproofing result.", image: "/images/pu-injection-checking.png" },
    ],
  },
];
